                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input id="firstname" type="text" name="fname" class="form-control" value="<?php echo $fname;?>"><span class="error">*<?php echo $fname_error;?></span>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="lastname">Last Name</label>
                        <input id="lastname" type="text" class="form-control" name="lname"value="<?php echo $lname;?>"><span class="error">*<?php echo $lname_error;?></span>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="email">Email</label>
                        <input id="email" type="text" class="form-control" name="email"value="<?php echo $email;?>"><span class="error">*<?php echo $email_error;?></span>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="subject">Subject</label>
                        <input id="subject" type="text" class="form-control"name="subj"value="<?php echo $subj;?>"><span class="error">*<?php echo $subj_error;?></span>
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label for="message">Message</label>
                        <textarea id="message" class="form-control" name="message" value="<?php echo $message;?>"></textarea><span class="error">*<?php echo $message_error;?></span>
                      </div>
                    </div>
