    ...
    if($error == 0)	
		...
		if(isset($_FILES["item_picture"]))
	 {
	  ...
	  if (file_exists($target_file))
	  {
		...
		if ($uploadOk == 0) 
		{
			$item_pictureErr= "Sorry, your file was not uploaded.";
		}
		 else 
	   {
		if (move_uploaded_file($_FILES["item_picture"]["tmp_name"], $target_file))
		 {
			  ...
			  include ('db.php');
	$qi="INSERT INTO `item`(`categoryID`, `item_name`, `brand`, `description`, `weight`, `height`, `width`, `material`, `size`, `color`, `item_picture`, `est_shipping_cost`, `item_fate`) VALUES ('".$category."','".$item_name."','".$brand."','".$description."','".$weight."','".$height."','".$width."','".$material."','".$size."','".$color."','".basename($_FILES["item_picture"]["name"])."','".$shipping."','".$item_fate."')";
$conn->query($qi);
//echo $qi;
...
?>
 ...
 <div class="row">
  <form class="form-group" action="item_val.php" method="POST" enctype="multipart/form-data">
 				 <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="material">Material</label><span class="error">*<?php echo $materialErr;?></span>
                        <input id="material" name="material" type="text" class="form-control" value="<?php echo $material;?>">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="color">Color</label><span class="error">*<?php echo $colorErr;?></span>
